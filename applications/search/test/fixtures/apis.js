export default [
  {
    ...
    hits: [
      ...
      },
      {
        ...
        description: {
          no:
            'Tilbyr et utvalg av opplysninger om alle registrerte enheter i Enhetsregisteret'
        },
        contactPoint: [
          {
        ...
        openApi: {
          ...
          paths: {
            ...
            '/seres/v1/repository/catalogs/{catalog}/{domain}/{model}/{version}': {
              ...
              put: {
                description:
                  'creates a new version object by copying it from another version',
                responses: {
                  '200': {
                    description: 'OK'
                  },
            ...
            '/seres/v1/repository/catalogs/{catalog}/domains': {
              get: {
                description:
                  'Returns a list of all domains under a specific catalog',
                responses: {
                  '200': {
                    description: 'OK'
                  },
            ...
            '/seres/v1/repository/catalogs': {
              get: {
                description:
                  'Returns a list of all catalogs stored by the repository (currently restriced to 1000 catalogs)',
                responses: {
                  '200': {
                    description: 'OK'
                  },
            ...
            '/seres/v1/repository/versions/{versionReference}/changelog': {
              get: {
                description:
                  'Returns the change events that has occured to a specific model-version. Pagination is required: ?page=0&size=20',
                responses: {
                  '200': {
                    description: 'OK'
                  },
